"""Phase 18 tests for Oseen actual field schema."""

import json

import numpy as np

from pinn_fluid.experiments import run_oseen_experiment
from pinn_fluid.figures import generate_figure_bundle


def test_run_oseen_experiment_uses_openfoam_reference_and_schema(
    tmp_path,
